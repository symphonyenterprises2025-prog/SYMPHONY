  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-3xl font-bold tracking-tight">New Add-On</h2>
          <p className="text-muted-foreground mt-1">
            Create a new optional extra for products
          </p>
        </div>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <form action={createAddOn} className="space-y-4 max-w-2xl">
            <div className="space-y-2">
              <Label htmlFor="name">Name *</Label>
              <Input id="name" name="name" required placeholder="e.g. Gift Wrap, Keychain" />
            </div>

            <div className="space-y-2">
              <Label htmlFor="description">Description</Label>
              <Textarea id="description" name="description" rows={2} placeholder="Brief description of the add-on" />
            </div>
